        ...
        {todos.map(todo =>
            <li className="todo-preview" key={todo._id}>
                ...
                <div className="options">
                    <Link className="btn" to={`/details${todo._id}`}><i className="fa-solid fa-info"></i></Link>
                    <Link className="btn" to={`/edit${todo._id}`}><i className="fa-solid fa-pen-to-square"></i></Link>
